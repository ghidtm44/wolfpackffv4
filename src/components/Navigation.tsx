    ...
    <>
      ...
      {showPasswordModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="retro-card w-full max-w-md bg-white">
            <h2 className="text-lg sm:text-xl mb-4 text-gray-900">Commissioner Login</h2>
            <input
              type="password"
              className="retro-input w-full mb-4 bg-white text-gray-900 border-gray-300"
              value={password}
